...
class GraphPlotterTrajectory:
    ...
    def plot_graph(self,land_point):
        ...
        plt.title('Mass')
        plt.plot(self.time_array , self.mass_log, label='All')
        plt.plot(self.time_array , self.mass_fuel_log, label='Fuel')
        plt.plot(self.time_array , self.mass_ox_log, label='Oxidizer')
        plt.plot(self.time_array , self.mass_prop_log, label='Propellant')
        plt.xlabel('Time [sec]')
        plt.ylabel('Mass [kg]')
        plt.xlim(xmin=0.0)
        plt.grid()
        ...
        plt.plot(self.time_array, self.Ij_pitch_log, label='Pitch')
        plt.plot(self.time_array, self.Ij_roll_log, label='Roll')
        plt.xlabel('Time [sec]')
        ...
        plt.grid()
        plt.legend()
        plt.savefig(self.filepath + '/' + flightType + '/AoA_AoS.png')
        ...
        plt.figure('Force Aero' + flightType)
        plt.title('Force Aero')
        ...
        plt.grid()
        plt.legend()
        plt.savefig(self.filepath + '/' + flightType + '/ForceAero.png')
        
        plt.figure('Force Thrust' + flightType)
        plt.title('Force Thrust')
        plt.plot(self.time_array , self.thrust_log, label='Thrust')
        plt.xlabel('Time [sec]')
        plt.ylabel('Force [N]')
        plt.xlim(xmin=0.0)
        plt.grid()
        plt.savefig(self.filepath + '/' + flightType + '/ForceThrust.png')
