...
class GraphPlotterTrajectory:
    ...
    def plot_graph(self,land_point):
        ...
        ax.plot(self.time_array[self.index_coast:], self.mass_fuel_log[self.index_coast:], color='#005AFF', linestyle='--')
        ax.plot(self.time_array[self.index_coast:], self.mass_ox_log[self.index_coast:]  , color='#03AF7A', linestyle='--')
        ax.plot(self.time_array[self.index_coast:], self.mass_prop_log[self.index_coast:], color='#4DC4FF', linestyle='--')
        ax.set_xlabel('Time [sec]')
