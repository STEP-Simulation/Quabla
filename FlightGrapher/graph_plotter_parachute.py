...
class GraphPlotterParachute:
    ...
    def plot_graph(self, make_kml, flag):
        ...
        if self.index_para2 > self.index_para1:
            ...
            ax.text(x=self.time_array[self.index_para1], y=self.time_step_array[self.index_para1], s='Drogue Chute Open\n', fontsize='medium', horizontalalignment='center', verticalalignment='center')
            ax.text(x=self.time_array[self.index_para2], y=self.time_step_array[self.index_para2], s='Main Chute Open\n', fontsize='medium', horizontalalignment='center', verticalalignment='center')
            ax.plot(self.time_array[self.index_para1], self.time_step_array[self.index_para1], marker='x', color='black')
            ax.plot(self.time_array[self.index_para2], self.time_step_array[self.index_para2], marker='x', color='black')
        else:
            ax.plot(self.time_array[self.index_para1:], self.time_step_array[self.index_para1:], color='#FF4B00', linestyle=':')
            ax.text(x=self.time_array[self.index_para1], y=self.time_step_array[self.index_para1], s='Main Chute Open\n', fontsize='medium', horizontalalignment='center', verticalalignment='center')
            ax.plot(self.time_array[self.index_para1], self.time_step_array[self.index_para1], marker='x', color='black')
        ...
        if self.index_para2 > self.index_para1:
            ...
            trajectory.text(x=self.downrange_log[self.index_para1], y=self.altitude_log[self.index_para1], s='Drogue Chute Open\n', fontsize='medium', horizontalalignment='center', verticalalignment='center')
            trajectory.text(x=self.downrange_log[self.index_para2], y=self.altitude_log[self.index_para2], s='Main Chute Open\n', fontsize='medium', horizontalalignment='center', verticalalignment='center')
            trajectory.plot(self.downrange_log[self.index_para1], self.altitude_log[self.index_para1], marker='x', color='black')
            trajectory.plot(self.downrange_log[self.index_para2], self.altitude_log[self.index_para2], marker='x', color='black')
        else:
            trajectory.plot(self.downrange_log[self.index_para1:], self.altitude_log[self.index_para1:], color='#FF4B00', linestyle=':')
            trajectory.text(x=self.downrange_log[self.index_para1], y=self.altitude_log[self.index_para1], s='Main Chute Open\n', fontsize='medium', horizontalalignment='center', verticalalignment='center')
            trajectory.plot(self.downrange_log[self.index_para1], self.altitude_log[self.index_para1], marker='x', color='black')
        ...
        trajectory.text(x=self.pos_NED_log[self.index_coast, 1] / 1000., y=self.pos_NED_log[self.index_coast, 0] / 1000., s='Engine cut-off\n', fontsize='medium', horizontalalignment='center', verticalalignment='center')
        trajectory.plot(self.pos_NED_log[self.index_coast, 1] / 1000., self.pos_NED_log[self.index_coast, 0] / 1000., marker='x', color='black')
        if self.index_para2 > self.index_para1:
            ...
            trajectory.text(x=self.pos_NED_log[self.index_para1, 1] / 1000., y=self.pos_NED_log[self.index_para1, 0] / 1000., s='Drogue Chute Open\n', fontsize='medium', horizontalalignment='center', verticalalignment='center')
            trajectory.text(x=self.pos_NED_log[self.index_para2, 1] / 1000., y=self.pos_NED_log[self.index_para2, 0] / 1000., s='Main Chute Open\n', fontsize='medium', horizontalalignment='center', verticalalignment='center')
            trajectory.plot(self.pos_NED_log[self.index_para1, 1] / 1000., self.pos_NED_log[self.index_para1, 0] / 1000., marker='x', color='black')
            trajectory.plot(self.pos_NED_log[self.index_para2, 1] / 1000., self.pos_NED_log[self.index_para2, 0] / 1000., marker='x', color='black')
        else:
            ...
            trajectory.text(x=self.pos_NED_log[self.index_para1, 1] / 1000., y=self.pos_NED_log[self.index_para1, 0] / 1000., s='Main Chute Open\n', fontsize='medium', horizontalalignment='center', verticalalignment='center')
            trajectory.plot(self.pos_NED_log[self.index_para1, 1] / 1000., self.pos_NED_log[self.index_para1, 0] / 1000., marker='x', color='black')
        ...
        ax.text(x=self.time_array[self.index_coast], y=self.mass_log[self.index_coast], s='Engine cut-off\n', fontsize='medium', horizontalalignment='center', verticalalignment='center')
        ax.plot(self.time_array[self.index_coast], self.mass_log[self.index_coast], marker='x', color='black')
        if self.index_para2 > self.index_para1:
            ...
            ax.text(x=self.time_array[self.index_para1], y=self.mass_log[self.index_para1], s='Drogue Chute Open\n', fontsize='medium', horizontalalignment='center', verticalalignment='center')
            ax.text(x=self.time_array[self.index_para2], y=self.mass_log[self.index_para2], s='Main Chute Open\n', fontsize='medium', horizontalalignment='center', verticalalignment='center')
            ax.plot(self.time_array[self.index_para1], self.mass_log[self.index_para1], marker='x', color='black')
            ax.plot(self.time_array[self.index_para2], self.mass_log[self.index_para2], marker='x', color='black')
        else:
            ax.plot(self.time_array[self.index_para1:], self.mass_log[self.index_para1:], color='#FF4B00', linestyle=':')
            ax.text(x=self.time_array[self.index_para1], y=self.mass_log[self.index_para1], s='Main Chute Open\n', fontsize='medium', horizontalalignment='center', verticalalignment='center')
            ax.plot(self.time_array[self.index_para1], self.mass_log[self.index_para1], marker='x', color='black')
        ax.set_xlabel('Time [sec]')
