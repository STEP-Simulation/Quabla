...
public class OtherVariableOnLauncher extends OtherVariableTrajectory {

    private final double altitude0;
    // private final double x

    public OtherVariableOnLauncher(Rocket rocket){
        super(rocket);
    ...
    public void setOtherVariable(double time, double[] posNED, double[] velBODY, double[] omegaBODY, double[] quat) {
        ...
        // MathematicalMatrix tensor = new MathematicalMatrix(Coordinate.Omega_tensor(omegaBODY[0], omegaBODY[1], omegaBODY[2]));
		// super.quatdot = tensor.dot(new MathematicalVector(quat)).multiply(0.5);
    }
